...
public class PaymentsUtil {
    ...
    public static PaymentsClient createPaymentsClient(Activity activity) {
        Wallet.WalletOptions walletOptions =
                new Wallet.WalletOptions.Builder().setEnvironment(com.example.payment.Constants.PAYMENTS_ENVIRONMENT).build();
    ...
    private static JSONObject getGatewayTokenizationSpecification() throws JSONException {
        return new JSONObject() {{
            ...
            put("parameters", new JSONObject() {{
                put("gateway", "mpgs"); // Mastercard
                put("gatewayMerchantId", "exampleGatewayMerchantId"); // NO ID Yet
            }});
        }};
    }
    ...
    private static JSONObject getDirectTokenizationSpecification()
        ...
        if (com.example.payment.Constants.DIRECT_TOKENIZATION_PARAMETERS.isEmpty()
                || com.example.payment.Constants.DIRECT_TOKENIZATION_PUBLIC_KEY.isEmpty()
                || com.example.payment.Constants.DIRECT_TOKENIZATION_PUBLIC_KEY == null
                || com.example.payment.Constants.DIRECT_TOKENIZATION_PUBLIC_KEY == "REPLACE_ME") {
        ...
        JSONObject parameters = new JSONObject(com.example.payment.Constants.DIRECT_TOKENIZATION_PARAMETERS);
    ...
    private static JSONArray getAllowedCardNetworks() {
        return new JSONArray(com.example.payment.Constants.SUPPORTED_NETWORKS);
    }
    ...
    private static JSONArray getAllowedCardAuthMethods() {
        return new JSONArray(com.example.payment.Constants.SUPPORTED_METHODS);
    }
    ...
    private static JSONObject getTransactionInfo(String price) throws JSONException {
        ...
        transactionInfo.put("countryCode", com.example.payment.Constants.COUNTRY_CODE);
        transactionInfo.put("currencyCode", com.example.payment.Constants.CURRENCY_CODE);
    ...
    public static Optional<JSONObject> getPaymentDataRequest(long priceCents) {
      ...
      JSON object. */
            ...
            JSONArray allowedCountryCodes = new JSONArray(com.example.payment.Constants.SHIPPING_SUPPORTED_COUNTRIES);
